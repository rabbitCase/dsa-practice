...
//on testing results for tes t cases with n =1,2,3,4 and 5 we notice a familiar pattern: the fibonacci series. This reduces the problem to return the (n+2)th order, provided you start with the third order, of the fibonacci series
class Solution {
public:
