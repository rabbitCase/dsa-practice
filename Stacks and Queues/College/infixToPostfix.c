...
6) If a closing bracket ')' is encountered, pop the elements of the stack until '(' is encountered and append the poppped elements into the postfix expression. Then pop one more time to remove the '(' as it is not required.
